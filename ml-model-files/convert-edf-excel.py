...
# Reading the .edf using mne library
...
print("-----------------------------------------------")
print()
print('Channels: ', chan) # printing the channels
print()
print("-----------------------------------------------")
print()
# printing other important graphs
print('Sampling frequency =', sf, 'Hz')
print('Data shape =', data.shape)

# Picking the required channel
